...
public class SQLiteFoodHelper extends SQLiteOpenHelper {
    ...
    public List<Food> getAll() {
        ...
        while ((rs != null) && rs.moveToNext()) {
            ...
            list.add(new Food(id, category, name, price, restaurant, rating, orders, image));
        }
        return list;
    }
    ...
    public Food getFoodById(int id) {
        ...
        if (rs.moveToNext()) {
            ...
            int orders = rs.getInt(6);
            int image = rs.getInt(7);
            Food o = new Food(id, category, name, price, restaurant, rating, orders, image);
            return o;
        }
        return null;
    }
    ...
    public List<Food> getFoodsByNameAndCategory(int category, String name) {
        ...
        while (rs.moveToNext()) {
            ...
            int orders = rs.getInt(6);
            int image = rs.getInt(7);
            Food o = new Food(id, ocategory, oname, price, restaurant, rating, orders, image);
            foods.add(o);
        }
        return foods;
    }
    ...
    public List<Food> getFoodsByRestaurant(String restaurant) {
        ...
        while (rs.moveToNext()) {
            ...
            int orders = rs.getInt(6);
            int image = rs.getInt(7);
            Food o = new Food(id, category, oname, price, orestaurant, rating, orders, image);
            foods.add(o);
        }
        return foods;
    }
    ...
    public List<Food> getFoodsByRestaurantAndName(String name, String restaurant) {
        ...
        while (rs.moveToNext()) {
            ...
            int orders = rs.getInt(6);
            int image = rs.getInt(7);
            Food o = new Food(id, category, oname, price, orestaurant, rating, image);
            foods.add(o);
        }
        return foods;
    }
